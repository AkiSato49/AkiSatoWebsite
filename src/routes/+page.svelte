...
<svelte:head>
  <title>Carlos Aki Sato</title>
  <meta name="description" content="Software engineer & designer — Carlos Aki Sato Cerda, Sydney" />
...
<Hero />
<About />
<PhotoStrip height={130} speed={50} count={14} />
<Projects />
